    ...
    <div class="section-content">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1 class="title text-white">Retreat</h1>
...
<section style="background-image: url('{{ asset('assets/front/images/pattern/p4.png') }}');">
  <div class="container">
    <div class="row">
      <div class="col-md-5">
        <img src="{{ asset('assets/coming_soon.webp') }}" alt="Upcoming yoga retreats">
      </div>
      <div class="col-md-7">
        <div class="mb-40">
          <h2 class="text-uppercase text-center font-38 mt-0"><span class="text-theme-colored">MORE retreat</span> COMING SOON</h2>
        </div>
