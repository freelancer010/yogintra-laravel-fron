...
<!-- Section: Yoga Centers -->
<section class="locate-us-section bg-light">
    <div class="container">
        <div class="section-content">
            <div class="row mb-40">
                <div class="col-md-12">
                    <h2 class="location-heading">Our Yoga Centers</h2>
                    <p class="section-subtitle">
                        Visit our physical yoga centers for in-person classes, workshops, and personalized training sessions.
                    </p>
                </div>
            </div>
            ...
            @if($all_center && count($all_center) > 0)
                <div class="row">
                    @foreach ($all_center as $center)
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mb-30">
                            <div class="bg-white center-card">
                                <!-- Center Image -->
                                <div class="center-image">
                                    <img class="img-fullwidth" alt="{{ $center->center_name }}" 
                                         src="{{ asset($center->center_image) }}" 
                                         onerror="this.src='{{ asset('assets/placeholder.jpg') }}'">
                                    <div class="overlay">
                                        <a href="{{ url('/yoga-center/' . $center->center_slug) }}" title="View Details">
                                ...
                                <div class="center-info">
                                    <h4 class="center-name">{{ $center->center_name }}</h4>

                                    @if($center->center_city)
                                    ...
                                    @if($center->mobile_number)
                                        <div class="center-contact">
                                            <i class="fa fa-phone"></i>
                                            <a href="tel:{{ $center->mobile_number }}">{{ $center->mobile_number }}</a>
                                        </div>
                                    @endif
                                    ...
                                    @if($center->email_address)
                                        <div class="center-contact">
                                            ...
                                            <a href="mailto:{{ $center->email_address }}">{{ $center->email_address }}</a>
                                        </div>
                                    @endif

                                    <a href="{{ url('/yoga-center/' . $center->center_slug) }}" class="btn-details">
                                        View Details
                                    </a>
                                </div>
                            </div>
    ...
    <div class="container pb-30 pt-30">
        <div class="row">
            <div class="col-md-8 pr-40">
                <h3 class="text-white mb-15">Can't Find Your City?</h3>
                <p class="text-white-777">We're constantly expanding our reach. Contact us to inquire about yoga classes in your area or to schedule private online sessions.</p>
            </div>
            <div class="col-md-4 text-right">
                <a href="{{ url('/contact') }}" class="btn btn-white mt-10">Contact Us</a>
            </div>
        </div>
    </div>
</section>
