...
@section('meta_title', 'Fundamentals of Yoga Workshop - YogIntra')
@section('meta_description', "A Beginner's Workshop for Every Yogi. Join us! Yoga Basics and Beyond is the perfect workshop if you are new to yoga or an experienced student, visit our site.")
@section('meta_keywords', 'Yoga Class Workshop in Mumbai, Online Yoga Classes India, Yoga Class in India, Best Yoga Institute In India, Best Yoga Center in India, Personal Yoga Trainer at Home, Best Yoga Classes in Mumbai, Yoga Teacher Training Courses.')
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 sm-text-center mb-30 mb-sm-30">
          <div class="schedule-box bg-light mb-30 event-card-ag">
            ...
            <div class="schedule-details clearfix p-15 pt-5" style="border-bottom: none!important;">
              ...
              <div class="mt-10">
                <a class="btn btn-dark btn-theme-colored btn-sm mt-10" href="{{ url('workshop/'.$event->link) }}">Register</a>
...
<section style="background-image: url('{{ asset('assets/front/images/pattern/p4.png') }}');">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7">
        <div class="mb-40">
          <h1 class="text-uppercase text-center font-38 mt-0"><span class="text-theme-colored">MORE WORKSHOP</span> COMING SOON</h1>
        </div>
