...
@section('content')
    ...
    <section class="divider types-of-yoga-section py-70" style="background-image: url('{{ asset('assets/parallax-decor2.png') }}'); background-position: center center; background-size: cover;">
        <div class="container">
