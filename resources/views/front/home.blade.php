...
@section('content')
    ...
    <style>
        ...
        @media(max-width:767px){.types-of-yoga-section .section-content>.row{margin-left:0!important;margin-right:0!important}.types-of-yoga-section .section-content .col-lg-ipad{display:block!important;width:100%!important;max-width:100%!important;flex:0 0 100%!important;padding:0!important}.types-of-yoga-section .section-content .col-lg-ipad>[class*="col-"]{display:block!important;float:none!important;width:calc(100% - 28px)!important;max-width:420px!important;flex:0 0 auto!important;margin:0 auto!important;padding:0!important}.types-of-yoga-section .section-content .col-lg-ipad>[class*="col-"] .yoga-service-item{width:100%!important;box-sizing:border-box;text-align:center}.types-of-yoga-section .section-content .col-lg-ipad>[class*="col-"]:not(:last-of-type) .yoga-service-item{margin-bottom:28px!important}.types-of-yoga-section .section-content .col-lg-ipad>[class*="col-"] .yoga-service-item h2{text-align:center}.types-of-yoga-section .section-content .col-lg-ipad>.col-md-4:empty{display:none!important}}
    </style>
