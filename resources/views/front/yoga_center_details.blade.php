                                ...
                                <li>
                                    <div class="bg-light media border-bottom p-15 mb-20">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>{{ $center->center_address }}, {{ $center->center_city }},
                                                {{ $center->center_state }},
                            ...
                            <ul>
                                <li>
                                    <div class="bg-light media border-bottom p-15 pb-0">
                                        ...
                                        <div class="media-body">
                                            <a class="d-flex"
                                                href="mailto:{{ $center->email_address }}">{{ $center->email_address }}</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="bg-light media border-bottom p-15 pb-0">
                                        ...
                                        <div class="media-body">
                                            <a class="d-flex"
                                                href="tel:{{ $center->mobile_number }}">{{ $center->mobile_number }}</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="styled-icons icon-sm icon-gray icon-circled">
                                            ...
                                            <a href="https://www.linkedin.com/in/yogintra/"><i
        ...
        function locationInfo() {
            ...
            this.getCountries = function() {
                ...
                call.send({}, url, 'post', function(data) {
                    ...
                    jQuery.each(data['result'], function(key, val) {
                        let option =
                            `<option value='${val.name}' countryid='${val.id}'>${val.name}</option>`;
