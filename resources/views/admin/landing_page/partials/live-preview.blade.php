...
(() => {
  ...
  function renderStyles(card, target = card.dataset.selectedTarget || 'section') {
    ...
    const extraElementControls = !['image', 'testimonial', 'faq'].includes(type) ? '<div class="block-editor"><label>Extra section elements</label>' + extraElements.map((element, index) => {
