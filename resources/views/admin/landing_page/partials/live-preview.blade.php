...
(() => {
  ...
  preview.innerHTML = '<div class="live-preview-toolbar"><span class="builder-save-indicator"><i class="preview-dot"></i><span class="builder-save-state">Saved</span></span><div class="preview-toolbar-controls"><label class="auto-save-control" for="auto-save-toggle"><input type="checkbox" id="auto-save-toggle" checked><span class="auto-save-switch" aria-hidden="true"></span><span>Auto save</span></label><span class="builder-device-controls"><button type="button" data-device="desktop" class="is-active">Desktop</button><button type="button" data-device="tablet">Tablet</button><button type="button" data-device="mobile">Mobile</button></span></div></div><div class="live-preview-content"></div>';
